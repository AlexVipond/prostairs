  ...
  function() {
    ...
    return _c("div", {}, [
      _c(
        ...
        {
          staticClass:
            "font-bold text-xl md:text-2xl text-grey-lightest text-shadow"
        },
        [
          _c("h3", { staticClass: "mb-2" }, [_vm._v("Analog.")]),
          _vm._v(" "),
          _c("h3", [_vm._v("Digital.")])
        ]
      ),
      _vm._v(" "),
      _c(
        ...
        {
          staticClass:
            "mt-4 mb-12 font-bold text-5xl md:text-6xl leading-none text-white text-shadow"
        },
        [_vm._v("Human.")]
      ),
      _vm._v(" "),
      _c(
        ...
        {
          staticClass:
            "mb-12 text-xl md:text-2xl leading-normal text-grey-lightest text-shadow"
        },
        [
          _vm._v("\n    Discover the power of a\n    "),
          _c("span", { staticClass: "font-medium text-white" }, [
            _vm._v("human mastering engineer")
          ]),
          _vm._v(".\n    "),
