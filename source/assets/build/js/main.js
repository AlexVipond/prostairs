...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      en: {
        primary_value: 'Finish Carpentry',
        secondary_value: 'Design',
        tertiary_value: 'Installation'
      },
      es: {
        primary_value: 'Finish Carpentry',
        secondary_value: 'Design',
    ...
    _c(
      ...
      [
        _c("h3", { staticClass: "mb-2" }, [
          _vm._v(_vm._s([_vm.language].secondary_value) + ".")
        ]),
        _vm._v(" "),
        _c("h3", [_vm._v(_vm._s([_vm.language].tertiary_value) + ".")])
      ]
    ),
    _vm._v(" "),
    _c(
      ...
      [_vm._v(_vm._s([_vm.language].primary_value) + ".")]
    ),
    _vm._v(" "),
    _vm._m(0)
  ])
