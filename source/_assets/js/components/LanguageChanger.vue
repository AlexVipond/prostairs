<template lang="html">
  <div class="cursor-pointer relative transition flex items-center">
    ...
    @mouseleave="showLanguageName = false">
      ...
      <svg class="inline-block h-5 w-5 md:h-6 md:w-6 ml-2 stroke-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
