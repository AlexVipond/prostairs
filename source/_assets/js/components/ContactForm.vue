  ...
  <div class="flex flex-col w-full pt-6 pb-8 sm:pt-8 sm:pb-10 bg-white rounded-lg shadow-lg text-black">
    ...
    <div class="w-full flex items-center justify-center">
      <svg class="h-6 sm:h-8" viewBox="0 0 4358 1008" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M689.825 437.5V587.5C689.825 615.114 667.439 637.5 639.825 637.5H331.246C304.725 637.5 279.289 626.964 260.536 608.211L119.114 466.789C100.361 448.036 89.8249 422.6 89.8249 396.079V37.5H289.825V237.5H489.825V437.5H689.825Z" fill="#B2B8D2"/>
        ...
        <path d="M74.9999 0H303.95H330.666C348.484 0 357.407 21.5429 344.808 34.1422L333.239 45.7107C314.486 64.4643 289.05 75 262.529 75H116.421C89.8996 75 64.4642 64.4643 45.7106 45.7107L34.1421 34.1422C21.5428 21.5429 30.4661 0 48.2842 0H74.9999Z" fill="#3E4E8E"/>
      </svg>
    </div>
  </div>
</template>
