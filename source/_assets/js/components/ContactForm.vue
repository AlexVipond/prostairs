  ...
  <div class="flex flex-col w-full pt-6 pb-8 sm:pt-8 sm:pb-10 bg-white rounded-lg shadow-lg text-black">
    ...
    <div class="w-full flex items-center justify-center">
      <svg class="h-6 sm:h-8" viewBox="0 0 4358 1008" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M0 1004.42V816.296H116.72V842.935H30.4844V906.376H102.164V933.015H30.4844V1004.42H0Z" fill="#3E4E8E"/>
        ...
        <path d="M334.625 400.2H75H48.2843C30.4662 400.2 21.5429 421.743 34.1422 434.342L45.7107 445.911C64.4643 464.664 89.8997 475.2 116.421 475.2H293.204C319.725 475.2 345.161 464.664 363.914 445.911L375.483 434.342C388.082 421.743 379.159 400.2 361.341 400.2H334.625Z" fill="#3E4E8E"/>
        <path d="M712.775 0H483.825H457.109C439.291 0 430.368 21.5429 442.967 34.1422L454.536 45.7107C473.289 64.4643 498.725 75 525.246 75H671.354C697.875 75 723.311 64.4643 742.064 45.7107L753.633 34.1422C766.232 21.5429 757.309 0 739.491 0H712.775Z" fill="#3E4E8E"/>
      </svg>
    </div>
  </div>
</template>
